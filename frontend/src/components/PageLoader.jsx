...
export default function PageLoader({ visible }) {
  return (
    <div
      className={`rns-page-loader${visible ? "" : " rns-page-loader--hide"}`}
      role="status"
      aria-live="polite"
      aria-label="Loading RNS INFOTECH"
    >
      <div className="rns-page-loader__mark">
        <img src="/assets/rns_logo.jpg" alt="" className="rns-page-loader__logo" />
      </div>
      ...
      <style>{`
        ...
        .rns-page-loader--hide {
          opacity: 0;
          visibility: hidden;
          transition: opacity 0.4s ease, visibility 0s linear 0.4s;
          pointer-events: none;
        }
        .rns-page-loader__mark {
          display: flex;
          align-items: center;
          justify-content: center;
          border-radius: 20px;
        ...
        @media (prefers-reduced-motion: reduce) {
          .rns-page-loader__logo { animation: none; opacity: 1; transform: none; }
        }
      `}</style>
    </div>
  );
