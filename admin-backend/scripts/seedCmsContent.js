...
const policies = {
  ...
  returns: {
    updated: "August 2026",
    intro: "This policy explains how returns, exchanges, and refunds work for orders placed through the RNS INFOTECH website.",
    sections: [
      { title: "Return window", body: "Most products can be returned within 7 days of delivery. Pen displays and pen tablets must be unused, in their original packaging, with all accessories, manuals, and seals intact." },
      { title: "Damaged or defective on arrival", body: "If an item arrives damaged or isn't working, email us within 48 hours of delivery with your order ID and photos or a short video of the issue." },
      { title: "Change of mind", body: "For change-of-mind returns, the item must be unopened and unused; return shipping is the customer's responsibility unless the order qualified for free returns." },
      { title: "What can't be returned", body: "Stylus nibs and consumables once the packaging is opened, products with a broken hygiene or warranty seal, and items reported outside the 7-day window can't be accepted." },
      { title: "How to start a return", body: "Email support@rnsinfotech.in with your order ID and reason for return, or use the Track an order page to start the request." },
      { title: "Refunds", body: "Once the returned item passes inspection, refunds are issued to the original payment method within 5–7 business days." },
      { title: "Exchanges", body: "Let support know when you start the return and we'll set up an exchange, adjusting for any price difference." },
      { title: "After the return window", body: "Issues that come up after 7 days are usually covered under manufacturer warranty rather than this return policy." },
    ],
  },
  terms: {
    updated: "August 2026",
    ...
    sections: [
      ...
      { title: "Returns", body: "Return and refund requests are handled case by case; contact support before sending anything back." },
